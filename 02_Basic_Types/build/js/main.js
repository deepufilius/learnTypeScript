...
let lastName = "Gen"; // Explicit type declaration where the exact type is defined, it'll throw an error if assigned value is not that type
let age;
age = 28;
let isPassed = true;
let isActive; // union type - it can have all three types
isActive = 0;
isActive = "yes";
isActive = false;
let album; // it can store any type, which actually defeats the purpose of TS but it has some use cases
